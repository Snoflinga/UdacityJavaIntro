...
// To create a circle where the upper left-hand corner of the surrounding rectangle
...
public class CirclePyramid
{
     ...
     * @param x the x coordinate of the upper left-hand corner of the pyramid
     * @param y the y coordinate of the upper left-hand corner of the pyramid
