...
public class Car6
{
    private ArrayList<Person6> passengers;
    private int numberOfSeats;
    private String driverName;
    private int location;
    private int destination;

    public Car6(String driverName, int numberOfSeats, int destination)
    {
        passengers = new ArrayList<Person6>();
    ...
    */
    public boolean tryToAdd(Person6 p)
    {
